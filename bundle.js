...
/***/ function(module, exports, __webpack_require__) {
	...
	var _LoginBox = __webpack_require__(196);

	var _LoginBox2 = _interopRequireDefault(_LoginBox);

	var _MainBox = __webpack_require__(197);
	...
	var App = function (_Component) {
		...
		_createClass(App, [{
			...
			value: function render() {
				...
				var statue = _props.statue;
				var personInfo = _props.personInfo;
				var friendsList = _props.friendsList;
				var message = _props.message;
				var actions = _props.actions;

				console.log(statue);
				var isLogin = statue !== "LOGOUTED";

				return _react2.default.createElement(
					"div",
					null,
					isLogin ? _react2.default.createElement(_MainBox2.default, null) : _react2.default.createElement(_LoginBox2.default, {
						login: actions.login,
	...
	function mapDispatchToProps(dispatch) {
		return {
			actions: (0, _redux.bindActionCreators)(_user2.default, dispatch)
		};
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	function loginPost(user, pass) {
		return function (dispatch, getState) {
			dispatch(logining());
			return (0, _isomorphicFetch2.default)(_Api2.default.login, {
				method: "POST",
...
/***/ function(module, exports, __webpack_require__) {
	...
	var LoginBox = function (_Component) {
		...
		function LoginBox() {
			...
			var _this = _possibleConstructorReturn(this, (_Object$getPrototypeO = Object.getPrototypeOf(LoginBox)).call.apply(_Object$getPrototypeO, [this].concat(props)));

			_this.loginPost = _this.loginPost.bind(_this);
			return _this;
		}

		_createClass(LoginBox, [{
			key: "loginPost",
			value: function loginPost(e) {
				e.preventDefault();
			...
			value: function render() {
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(
							"button",
							{ type: "button", onClick: this.loginPost },
							"登录"
						)
					)
				);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var MainBox = function (_Component) {
		...
		function MainBox() {
			...
			return _possibleConstructorReturn(this, Object.getPrototypeOf(MainBox).apply(this, arguments));
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _statue = __webpack_require__(201);

	var _statue2 = _interopRequireDefault(_statue);

	var _personInfo = __webpack_require__(202);

	var _personInfo2 = _interopRequireDefault(_personInfo);

	var _friendsList = __webpack_require__(203);
	...
	var rootReducer = (0, _redux.combineReducers)({
		statue: _statue2.default,
		personInfo: _personInfo2.default,
		friendsList: _friendsList2.default,
...
/***/ function(module, exports, __webpack_require__) {
	...
	function statue() {
		var state = arguments.length <= 0 || arguments[0] === undefined ? "LOGOUTED" : arguments[0];
		var action = arguments[1];

		switch (action.type) {
			case _User2.default.LOGINING:
				return _User2.default.LOGINING;
			case _User2.default.LOGINED:
				return _User2.default.LOGINED;
			case _User2.default.LOGOUTED:
				return _User2.default.LOGOUTED;
			default:
				return state;
		}
	}
